...
CREATE TABLE
  IF NOT EXISTS `account_ban_history` (
...
CREATE TABLE
  IF NOT EXISTS `player_namelocks` (
...
CREATE TABLE
  IF NOT EXISTS `guild_membership` (
    `player_id` int NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `players_online` (
    `player_id` int NOT NULL,
    PRIMARY KEY (`player_id`)
  ) ENGINE = MEMORY DEFAULT CHARACTER
SET
  = utf8;

CREATE TABLE
  IF NOT EXISTS `player_deaths` (
    `player_id` int NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `player_depotitems` (
    `player_id` int NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `player_rewarditems` (
    `player_id` int NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `player_inboxitems` (
    `player_id` int NOT NULL,
    `sid` int NOT NULL,
    `pid` int NOT NULL DEFAULT '0',
    `itemtype` smallint unsigned NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `player_storeinboxitems` (
    `player_id` int NOT NULL,
    `sid` int NOT NULL,
    `pid` int NOT NULL DEFAULT '0',
    `itemtype` smallint unsigned NOT NULL,
